...
public class WrappedByteBuf extends ByteBuf {
    ...
    public ByteBuf readBytes(io.netty.buffer.ByteBuf dst) {
        this.buf.readBytes(dst);
        return this;
    }

    public ByteBuf readBytes(io.netty.buffer.ByteBuf dst, int length) {
        this.buf.readBytes(dst, length);
        return this;
    }

    public ByteBuf readBytes(io.netty.buffer.ByteBuf dst, int dstIndex, int length) {
    ...
    public int readBytes(java.nio.channels.GatheringByteChannel out, int length) throws IOException {
    ...
    public ByteBuf writeBytes(io.netty.buffer.ByteBuf src) {
        this.buf.writeBytes(src);
        return this;
    }

    public ByteBuf writeBytes(io.netty.buffer.ByteBuf src, int length) {
        this.buf.writeBytes(src, length);
        return this;
    }

    public ByteBuf writeBytes(io.netty.buffer.ByteBuf src, int srcIndex, int length) {
    ...
    public int writeBytes(java.nio.channels.ScatteringByteChannel in, int length) throws IOException {
        return this.buf.writeBytes(in, length);
    }
    ...
    public int forEachByteDesc(io.netty.buffer.ByteBufProcessor processor) {
